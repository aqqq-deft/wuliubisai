...
void car_init(void) {
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_8 | GPIO_Pin_9;   //??CH3??PB0
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;   
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOB, &GPIO_InitStructure); 
}

void car_set(u8 index, u8 level) {
	switch(index) {
		case 1:level?gpioB_pin_set(0, 1):gpioB_pin_set(0, 0);break;
		case 2:level?gpioB_pin_set(1, 1):gpioB_pin_set(1, 0);break;
		case 3:level?gpioB_pin_set(9, 1):gpioB_pin_set(9, 0);break;
		case 4:level?gpioB_pin_set(8, 1):gpioB_pin_set(8, 0);break;
	}
}
